(() => {
    ...
    const script_menuClose = document.querySelector(".close-menu");
    if (script_menuClose) script_menuClose.addEventListener("click", (function(e) {
        script_menuClose.classList.toggle("_close-menu-active");
